...
public class FullCheck extends ToggleInteraction {
	public FullCheck(String packagename, String search_type, String search_keyword, String timestamp,
	...
	public void extractBounds() {
		...
		bottom = Integer.parseInt(separated[0]);
		top = Integer.parseInt(separated[1]);
		right = Integer.parseInt(separated[2]);
		left = Integer.parseInt(separated[3]);
	}
