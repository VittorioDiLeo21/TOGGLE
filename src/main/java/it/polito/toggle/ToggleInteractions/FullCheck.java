...
public class FullCheck extends ToggleInteraction {
	...
	public void extractBounds() {
		...
		bottom = Integer.valueOf(separated[0]);
		top = Integer.valueOf(separated[1]);
		right = Integer.valueOf(separated[2]);
		left = Integer.valueOf(separated[3]);
	}

	@Override
	public ArrayList<String> generateEyeAutomateJavaLines(String starting_folder) {
		ArrayList<String> res = new ArrayList<>();
		res.add("interactionName = \"FullCheck\";");
