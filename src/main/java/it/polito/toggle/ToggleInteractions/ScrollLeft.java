...
public class ScrollLeft extends ToggleInteraction {

    private int scrollStep;
    private int toBeScrolled;

    public ScrollLeft(String packagename, String search_type, String search_keyword,
