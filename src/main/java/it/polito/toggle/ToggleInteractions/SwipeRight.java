...
public class SwipeRight extends ToggleInteraction {
	public SwipeRight(String packagename, String search_type, String search_keyword, String timestamp,
